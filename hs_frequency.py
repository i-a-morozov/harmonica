"""
usage: hs_frequency [-h] [-p {x,z}] [-l LENGTH] [-s BPM [BPM ...] | -o BPM [BPM ...]] [-r] [-f] [-c | -n] [--print] [--mean | --normalize] [-w]
                    [--name {cosine_window,kaiser_window}] [--order ORDER] [--pad PAD] [--min MIN] [--max MAX] [-m {fft,ffrft,parabola}] [--flip] [--plot]
...
if args.plot:
  ...
  title=f'{TIME}<br>MEAN: {mean} MEDIAN: {median} STD: {std}'
